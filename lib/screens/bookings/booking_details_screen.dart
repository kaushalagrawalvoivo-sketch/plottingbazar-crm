    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _tile("Sale Price", "₹ ${booking.salePrice.toStringAsFixed(2)}"),
          _tile("Discount", "₹ ${booking.discount.toStringAsFixed(2)}"),
          _tile("Balance", "₹ ${booking.balance.toStringAsFixed(2)}"),
          _tile(
            "Booking Date",
            booking.bookingDate.toString().split(' ').first,
          ),
          if (booking.createdAt != null)
            _tile("Created At", booking.createdAt.toString()),
        ],
      ),
    );
  }
